...
//       this.current_day_number = current_date[1].replace(current_date[1].slice(-2), '');
//       this.current_month_number = current_date[2];
//       this.current_year_number = current_date[3];
//
//       this.scheduled_date = $(".schedule-month").text().trim().split(' ');
//       this.scheduled_month = scheduled_date[0];
//       this.scheduled_year = scheduled_date[1];
//     }
//
