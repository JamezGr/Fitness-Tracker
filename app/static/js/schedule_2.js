...
// get Name of Month From Number ie. 1 - January, 12 - December
...
// get Total Days in Month to Display on Calendar
...
// get Available Days in Schedule
const daysInCurrentSchedule = () => {
  ...
  $(".calendar-day").each(function() {
      ...
      // get Date from Day clicked on Schedule by User
const getDateSelected = (year, month, day) => {
  ...
  let current_month_number = getFullMonth(createSchedule.current_month);
  let current_year_number = createSchedule.current_year_number;

  let scheduled_month_number = getFullMonth(createSchedule.scheduled_month);
  let scheduled_year_number = createSchedule.scheduled_year;

  let date_format = getDateSelected(current_year_number, current_month_number, current_day_number);
